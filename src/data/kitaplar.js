    ...
    alimler: [
      {
        ...
        altKategoriler: [
        {
          ...
          kitaplar: [
            { id: "sozler",            baslik: "Sözler",            yazar: "Bediüzzaman Said Nursî", dosya: "sozler-metin.json",            aciklama: "Risale-i Nur'un temel eseri; iman hakikatlerini temsil ve hikâyelerle anlatan otuz üç Söz." },
            { id: "mektubat",          baslik: "Mektubat",          yazar: "Bediüzzaman Said Nursî", dosya: "mektubat-metin.json",          aciklama: "Talebelerin sorularına verilen cevaplardan oluşan otuz üç Mektup." },
            { id: "lemalar",           baslik: "Lem'alar",          yazar: "Bediüzzaman Said Nursî", dosya: "lemalar-metin.json",           aciklama: "İman ve Kur'ân hakikatlerine dair otuz üç Lem'a; İhlas ve Hastalar Risalesi gibi bölümler." },
            { id: "sualar",            baslik: "Şuâlar",            yazar: "Bediüzzaman Said Nursî", dosya: "sualar-metin.json",            aciklama: "Âyetü'l-Kübrâ ve Meyve Risalesi gibi tahkikî iman derslerini içeren şuâlar." },
            { id: "mesnevi-i-nuriye",  baslik: "Mesnevî-i Nuriye",  yazar: "Bediüzzaman Said Nursî", dosya: "mesnevi-i-nuriye-metin.json",  aciklama: "Risale-i Nur'un çekirdeği sayılan, Arapça aslından tercüme kısa ve derin bahisler." },
            { id: "isaratul-icaz",     baslik: "İşârâtü'l-İ'câz",   yazar: "Bediüzzaman Said Nursî", dosya: "isaratul-icaz-metin.json",     aciklama: "Bakara sûresinin tefsiri; Kur'ân'ın nazmındaki i'câzı gösterir." },
            { id: "asa-yi-musa",       baslik: "Asâ-yı Mûsâ",       yazar: "Bediüzzaman Said Nursî", dosya: "asa-yi-musa-metin.json",       aciklama: "İman esaslarını delilleriyle ispatlayan iki kısımlık derleme." },
          ],
        },
        {
          id: "kucuk-eserler",
          ...
          kitaplar: [
            { id: "barla-lahikasi",              baslik: "Barla Lâhikası",              yazar: "Bediüzzaman Said Nursî", dosya: "barla-lahikasi-metin.json",              aciklama: "Barla döneminde talebelerle mektuplaşmalar." },
            { id: "kastamonu-lahikasi",          baslik: "Kastamonu Lâhikası",          yazar: "Bediüzzaman Said Nursî", dosya: "kastamonu-lahikasi-metin.json",          aciklama: "Kastamonu dönemi mektuplaşmaları." },
            { id: "emirdag-lahikasi",            baslik: "Emirdağ Lâhikası",            yazar: "Bediüzzaman Said Nursî", dosya: "emirdag-lahikasi-metin.json",            aciklama: "Emirdağ dönemi mektupları; hizmet düsturları." },
            { id: "iman-ve-kufur-muvazeneleri",  baslik: "İman ve Küfür Muvazeneleri",  yazar: "Bediüzzaman Said Nursî", dosya: "iman-ve-kufur-muvazeneleri-metin.json",  aciklama: "İman ile küfrün neticelerini karşılaştıran seçme bahisler." },
            { id: "sikke-i-tasdik-i-gaybi",      baslik: "Sikke-i Tasdîk-ı Gaybî",      yazar: "Bediüzzaman Said Nursî", dosya: "sikke-i-tasdik-i-gaybi-metin.json",      aciklama: "Risale-i Nur'a dair gaybî işaretler ve tevafuklar." },
            { id: "muhakemat",                   baslik: "Muhâkemat",                   yazar: "Bediüzzaman Said Nursî", dosya: "muhakemat-metin.json",                   aciklama: "İlk dönem eseri; Kur'ân hakikatlerinin anlaşılmasında usûl ve muhakeme." },
            { id: "tarihce-i-hayat",             baslik: "Tarihçe-i Hayat",             yazar: "Bediüzzaman Said Nursî", dosya: "tarihce-i-hayat-metin.json",             aciklama: "Bediüzzaman'ın hayatını dönem dönem anlatan biyografi." },
            { id: "ilk-donem-eserleri",          baslik: "İlk Dönem Eserleri",          yazar: "Bediüzzaman Said Nursî", dosya: "ilk-donem-eserleri-metin.json",          aciklama: "Münâzarât, Hutbe-i Şâmiye gibi erken dönem eserleri." },
          ],
        },
      ],
      },
