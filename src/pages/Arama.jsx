            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              ...
              <button onClick={() => setSecilenKitap(null)}
                style={{
                  ...
                  // `theme.surface` idi ve başlık kartların arasında kayboluyordu;
                  // oysa bu satır "şu an bu eserin içindesin" diyen tek işaret.
                  //
                ...
                <span style={{
                  ...
                  color: theme.accent,
                }}>{acikGrup.kitapAd}</span>
                <span style={{
                  fontSize: "12px", color: theme.accent, opacity: 0.75, flexShrink: 0,
                }}>{acikGrup.sonuclar.length} sonuç</span>
              </button>
